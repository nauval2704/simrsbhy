...
var gt = new D(""),
    Be = (() => {
        class n extends je {
            ...
            _composing = !1;
            constructor(e, i, r) {
                super(e, i), this._compositionMode = r, this._compositionMode == null && (this._compositionMode = !pt())
            }
            writeValue(e) {
                let i = e ?? "";
...
var P = new D(""),
    re = new D(""),
    mt = /^(?=.{1,254}$)(?=.{1,64}@)[a-zA-Z0-9!#$%&'*+/=?^_`{|}~-]+(?:\.[a-zA-Z0-9!#$%&'*+/=?^_`{|}~-]+)*@[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)*$/,
    Ie = class {
        static min(t) {
            return He(t)
        }
...
function yt(n) {
    return y(n.value) || mt.test(n.value) ? null : {
        email: !0
    }
}

function Ct(n) {
    return t => y(t.value) || !Ue(t.value) ? null : t.value.length < n ? {
        minlength: {
            requiredLength: n,
...
function Vt(n) {
    return t => Ue(t.value) && t.value.length > n ? {
        maxlength: {
            requiredLength: n,
            actualLength: t.value.length
        }
...
function Ze(n) {
    return n.map(t => bt(t) ? t : e => t.validate(e))
}
...
function Ne(n, t) {
    let e = ce(t);
    return ce(n).forEach(r => {
        K(e, r) || e.push(r)
    }), e
}

function Oe(n, t) {
    return ce(t).filter(e => !K(n, e))
}
var J = class {
        get value() {
        ...
        _composedValidatorFn;_composedAsyncValidatorFn;_rawValidators = [];_rawAsyncValidators = [];_setValidators(t) {
            this._rawValidators = t || [], this._composedValidatorFn = me(this._rawValidators)
        }
        _setAsyncValidators(t) {
            this._rawAsyncValidators = t || [], this._composedAsyncValidatorFn = _e(this._rawAsyncValidators)
        }
        get validator() {
    ...
    bn = (() => {
        class n extends Q {
            ...
            static \u0275dir = l({
                ...
                hostVars: 14,
                hostBindings: function(i, r) {
                    i & 2 && le("ng-untouched", r.isUntouched)("ng-touched", r.isTouched)("ng-pristine", r.isPristine)("ng-dirty", r.isDirty)("ng-valid", r.isValid)("ng-invalid", r.isInvalid)("ng-pending", r.isPending)
                },
                standalone: !1,
                features: [u]
            })
    ...
    An = (() => {
        class n extends Q {
            ...
            static \u0275dir = l({
                ...
                hostVars: 16,
                hostBindings: function(i, r) {
                    i & 2 && le("ng-untouched", r.isUntouched)("ng-touched", r.isTouched)("ng-pristine", r.isPristine)("ng-dirty", r.isDirty)("ng-valid", r.isValid)("ng-invalid", r.isInvalid)("ng-pending", r.isPending)("ng-submitted", r.isSubmitted)
                },
                standalone: !1,
                features: [u]
            })
...
function ve(n) {
    return (se(n) ? n.validators : n) || null
}

function Mt(n) {
    return Array.isArray(n) ? me(n) : n || null
}

function ye(n, t) {
    return (se(t) ? t.asyncValidators : n) || null
}

function Et(n) {
    return Array.isArray(n) ? _e(n) : n || null
}
...
function Qe(n, t, e) {
    let i = n.controls;
    if (!(t ? Object.keys(i) : i).length) throw new W(1e3, "");
    if (!i[e]) throw new W(1001, "")
}

function et(n, t, e) {
    n._forEachChild((i, r) => {
        if (e[r] === void 0) throw new W(1002, "")
    })
}
var O = class {
        _pendingDirty = !1;
        ...
        hasValidator(t) {
            return K(this._rawValidators, t)
        }
        hasAsyncValidator(t) {
            return K(this._rawAsyncValidators, t)
        }
        clearValidators() {
            this.validator = null
        }
        ...
        markAsTouched(t = {}) {
            ...
            this._parent && !t.onlySelf && this._parent.markAsTouched(f(d({}, t), {
                sourceControl: i
            })), e && t.emitEvent !== !1 && this._events.next(new U(!0, i))
        }
        markAllAsTouched(t = {}) {
            this.markAsTouched({
                onlySelf: !0,
        ...
        markAsUntouched(t = {}) {
            ...
            }), this._parent && !t.onlySelf && this._parent._updateTouched(t, i), e && t.emitEvent !== !1 && this._events.next(new U(!1, i))
        }
        markAsDirty(t = {}) {
            let e = this.pristine === !0;
            this.pristine = !1;
            let i = t.sourceControl ?? this;
            this._parent && !t.onlySelf && this._parent.markAsDirty(f(d({}, t), {
                sourceControl: i
            })), e && t.emitEvent !== !1 && this._events.next(new B(!1, i))
        }
        markAsPristine(t = {}) {
            ...
            }), this._parent && !t.onlySelf && this._parent._updatePristine(t, i), e && t.emitEvent !== !1 && this._events.next(new B(!0, i))
        }
        markAsPending(t = {}) {
            this.status = I;
            let e = t.sourceControl ?? this;
            t.emitEvent !== !1 && (this._events.next(new S(this.status, e)), this.statusChanges.emit(this.status)), this._parent && !t.onlySelf && this._parent.markAsPending(f(d({}, t), {
                sourceControl: e
            }))
        }
        disable(t = {}) {
            let e = this._parentMarkedDirty(t.onlySelf);
            this.status = T, this.errors = null, this._forEachChild(r => {
                r.disable(f(d({}, t), {
                    onlySelf: !0
                }))
            }), this._updateValue();
            let i = t.sourceControl ?? this;
            t.emitEvent !== !1 && (this._events.next(new ee(this.value, i)), this._events.next(new S(this.status, i)), this.valueChanges.emit(this.value), this.statusChanges.emit(this.status)), this._updateAncestors(f(d({}, t), {
                skipPristineCheck: e
            }), this), this._onDisabledChange.forEach(r => r(!0))
        }
        enable(t = {}) {
            let e = this._parentMarkedDirty(t.onlySelf);
            this.status = R, this._forEachChild(i => {
                i.enable(f(d({}, t), {
                    onlySelf: !0
                }))
        ...
        updateValueAndValidity(t = {}) {
            if (this._setInitialStatus(), this._updateValue(), this.enabled) {
                ...
                this.errors = this._runValidator(), this.status = this._calculateStatus(), (this.status === R || this.status === I) && this._runAsyncValidator(i, t.emitEvent)
            }
            let e = t.sourceControl ?? this;
            t.emitEvent !== !1 && (this._events.next(new ee(this.value, e)), this._events.next(new S(this.status, e)), this.valueChanges.emit(this.value), this.statusChanges.emit(this.status)), this._parent && !t.onlySelf && this._parent.updateValueAndValidity(f(d({}, t), {
                sourceControl: e
            }))
        }
        ...
        _setInitialStatus() {
            this.status = this._allControlsDisabled() ? T : R
        }
        _runValidator() {
        ...
        _runAsyncValidator(t, e) {
            if (this.asyncValidator) {
                this.status = I, this._hasOwnPendingAsyncValidator = {
                    emitEvent: e !== !1
                };
        ...
        _updateControlsErrors(t, e, i) {
            this.status = this._calculateStatus(), t && this.statusChanges.emit(this.status), (t || i) && this._events.next(new S(this.status, e)), this._parent && this._parent._updateControlsErrors(t, e, i)
        }
        _initObservables() {
            this.valueChanges = new b, this.statusChanges = new b
        }
        _calculateStatus() {
            return this._allControlsDisabled() ? T : this.errors ? X : this._hasOwnPendingAsyncValidator || this._anyControlsHaveStatus(I) ? I : this._anyControlsHaveStatus(X) ? X : R
        }
        ...
        _updatePristine(t, e) {
            let i = !this._anyControlsDirty(),
                r = this.pristine !== i;
            this.pristine = i, this._parent && !t.onlySelf && this._parent._updatePristine(t, e), r && this._events.next(new B(this.pristine, e))
        }
        _updateTouched(t = {}, e) {
            this.touched = this._anyControlsTouched(), this._events.next(new U(this.touched, e)), this._parent && !t.onlySelf && this._parent._updateTouched(t, e)
        }
        _onDisabledChange = [];
        ...
        _setUpdateStrategy(t) {
            se(t) && t.updateOn != null && (this._updateOn = t.updateOn)
        }
        ...
        _assignValidators(t) {
            this._rawValidators = Array.isArray(t) ? t.slice() : t, this._composedValidatorFn = Mt(this._rawValidators)
        }
        _assignAsyncValidators(t) {
            this._rawAsyncValidators = Array.isArray(t) ? t.slice() : t, this._composedAsyncValidatorFn = Et(this._rawAsyncValidators)
        }
    },
    x = class extends O {
        constructor(t, e, i) {
            super(ve(e), ye(i, e)), this.controls = t, this._initObservables(), this._setUpdateStrategy(e), this._setUpControls(), this.updateValueAndValidity({
                onlySelf: !0,
        ...
        setValue(t, e = {}) {
            et(this, !0, t), Object.keys(t).forEach(i => {
                Qe(this, !0, i), this.controls[i].setValue(t[i], {
                    onlySelf: !0,
                    emitEvent: e.emitEvent
                })
...
var k = new D("CallSetDisabledState", {
        providedIn: "root",
        factory: () => L
    }),
    L = "always";
...
function te(n, t, e = L) {
    Ce(n, t), t.valueAccessor.writeValue(n.value), (n.disabled || e === "always") && t.valueAccessor.setDisabledState?.(n.disabled), wt(n, t), St(n, t), It(n, t), Ft(n, t)
}

function xe(n, t, e = !0) {
    let i = () => {};
    t.valueAccessor && (t.valueAccessor.registerOnChange(i), t.valueAccessor.registerOnTouched(i)), ie(n, t), n && (t._invokeOnDestroyCallbacks(), n._registerOnCollectionChange(() => {}))
}
...
function Ce(n, t) {
    let e = Ke(n);
    t.validator !== null ? n.setValidators(Se(e, t.validator)) : typeof e == "function" && n.setValidators([e]);
    let i = Je(n);
    t.asyncValidator !== null ? n.setAsyncValidators(Se(i, t.asyncValidator)) : typeof i == "function" && n.setAsyncValidators([i]);
...
function ie(n, t) {
    ...
    let i = () => {};
    return ne(t._rawValidators, i), ne(t._rawAsyncValidators, i), e
}

function wt(n, t) {
    t.valueAccessor.registerOnChange(e => {
        n._pendingValue = e, n._pendingChange = !0, n._pendingDirty = !0, n.updateOn === "change" && nt(n, t)
    })
}

function It(n, t) {
    t.valueAccessor.registerOnTouched(() => {
        n._pendingTouched = !0, n.updateOn === "blur" && n._pendingChange && nt(n, t), n.updateOn !== "submit" && n.markAsTouched()
    })
}
...
function Ot(n) {
    return Object.getPrototypeOf(n.constructor) === H
}
...
function ot(n, t) {
    ...
    let e, i, r;
    return t.forEach(s => {
        s.constructor === Be ? e = s : Ot(s) ? i = s : r = s
    }), r || i || e || null
}
...
var Pt = {
    ...
    kt = (() => {
        class n extends m {
            ...
            options;
            constructor(e, i, r) {
                super(), this.callSetDisabledState = r, this.form = new x({}, me(e), _e(i))
            }
            ngAfterViewInit() {
            ...
            addControl(e) {
                j.then(() => {
                    ...
                    e.control = i.registerControl(e.name, e.control), te(e.control, e, this.callSetDisabledState), e.control.updateValueAndValidity({
                        emitEvent: !1
            ...
            addFormGroup(e) {
                j.then(() => {
                    let i = this._findContainer(e.path),
                        r = new x({});
                    it(r, e), i.registerControl(e.name, r), r.updateValueAndValidity({
                        emitEvent: !1
                    })
                })
            }
            ...
            onSubmit(e) {
                return this.submittedReactive.set(!0), st(this.form, this._directives), this.ngSubmit.emit(e), e?.target?.method === "dialog"
            }
            onReset() {
                this.resetForm()
            }
            ...
            static \u0275fac = function(i) {
                return new(i || n)(o(P, 10), o(re, 10), o(k, 8))
            };
            static \u0275dir = l({
                type: n,
                selectors: [
...
var N = class extends O {
        ...
        constructor(t = null, e, i) {
            super(ve(e), ye(i, e)), this._applyFormState(t), this._setUpdateStrategy(e), this._initObservables(), this.updateValueAndValidity({
                onlySelf: !0,
                emitEvent: !!this.asyncValidator
            }), se(e) && (e.nonNullable || e.initialValueIsDefault) && (ke(t) ? this.defaultValue = t.value : this.defaultValue = t)
        }
        setValue(t, e = {}) {
        ...
        _applyFormState(t) {
            ke(t) ? (this.value = this._pendingValue = t.value, t.disabled ? this.disable({
                onlySelf: !0,
                emitEvent: !1
            }) : this.enable({
                onlySelf: !0,
    ...
    Tt = (() => {
        class n extends C {
            ...
            constructor(e, i, r, s, a, p) {
                super(), this._changeDetectorRef = a, this.callSetDisabledState = p, this._parent = e, this._setValidators(i), this._setAsyncValidators(r), this.valueAccessor = ot(this, s)
            }
            ngOnChanges(e) {
                ...
                "isDisabled" in e && this._updateDisabled(e), rt(e, this.viewModel) && (this._updateValue(this.model), this.viewModel = this.model)
            }
            ngOnDestroy() {
            ...
            _getPath(e) {
                return this._parent ? tt(e, this._parent) : [e]
            }
            static \u0275fac = function(i) {
                return new(i || n)(o(m, 9), o(P, 10), o(re, 10), o(A, 10), o(we, 8), o(k, 8))
            };
            static \u0275dir = l({
                type: n,
                selectors: [
...
var Ht = (() => {
    ...
    Lt = (() => {
        class n extends H {
            ...
            static \u0275fac = function(i) {
                return new(i || n)(o(E), o(M), o(Ht), o(Ee))
            };
            static \u0275dir = l({
                type: n,
                selectors: [
...
var $t = {
    ...
    Wt = (() => {
        class n extends m {
            ...
            _submitted = w(() => this._submittedReactive());
            _submittedReactive = F(!1);
            _oldForm;
            ...
            ngOnDestroy() {
                this.form && (ie(this.form, this), this.form._onCollectionChange === this._onCollectionChange && this.form._registerOnCollectionChange(() => {}))
            }
            get formDirective() {
                return this
            }
            ...
            removeControl(e) {
                xe(e.control || null, e, !1), xt(this.directives, e)
            }
            addFormGroup(e) {
            ...
            onSubmit(e) {
                return this._submittedReactive.set(!0), st(this.form, this.directives), this.ngSubmit.emit(e), this.form._events.next(new he(this.control)), e?.target?.method === "dialog"
            }
            onReset() {
                this.resetForm()
            }
            resetForm(e = void 0) {
                this.form.reset(e), this._submittedReactive.set(!1), this.form._events.next(new fe(this.form))
            }
            _updateDomValue() {
                this.directives.forEach(e => {
                    let i = e.control,
                        r = this.form.get(e.path);
                    i !== r && (xe(i || null, e), Gt(r) && (te(r, e, this.callSetDisabledState), e.control = r))
            ...
            _setUpFormContainer(e) {
                let i = this.form.get(e.path);
                it(i, e), i.updateValueAndValidity({
                    emitEvent: !1
                })
            }
            _cleanUpFormContainer(e) {
                if (this.form) {
                    let i = this.form.get(e.path);
                    i && Nt(i, e) && i.updateValueAndValidity({
                        emitEvent: !1
                    })
                }
            }
            ...
            _updateValidators() {
                Ce(this.form, this), this._oldForm && ie(this._oldForm, this)
            }
            _checkFormPresent() {
                this.form
            }
    ...
    zt = (() => {
        class n extends C {
            ...
            constructor(e, i, r, s, a) {
                super(), this._ngModelWarningConfig = a, this._parent = e, this._setValidators(i), this._setAsyncValidators(r), this.valueAccessor = ot(this, s)
            }
            ngOnChanges(e) {
                this._added || this._setUpControl(), rt(e, this.viewModel) && (this.viewModel = this.model, this.formDirective.updateModel(this, this.model))
            }
            ngOnDestroy() {
                this.formDirective && this.formDirective.removeControl(this)
            }
            ...
            get path() {
                return tt(this.name == null ? this.name : this.name.toString(), this._parent)
            }
            get formDirective() {
                return this._parent ? this._parent.formDirective : null
            }
            ...
            static \u0275fac = function(i) {
                return new(i || n)(o(m, 13), o(P, 10), o(re, 10), o(A, 10), o(at, 8))
            };
            static \u0275dir = l({
                type: n,
                selectors: [
...
var ut = (() => {
    ...
    wn = (() => {
        class n {
            ...
            set ngValue(e) {
                this._select != null && (this._select._optionMap.set(this.id, e), this._setElementValue(lt(this.id, e)), this._select.writeValue(this._select.value))
            }
            set value(e) {
...
var dt = (() => {
                ...
                this.onChange = i => {
                    ...
                    if (s !== void 0) {
                        ...
                        for (let p = 0; p < a.length; p++) {
                            let $ = a[p];
                            if ($.selected) {
                                let oe = this._getOptionValue($.value);
                                r.push(oe)
                            }
                        }
                    }
    ...
    In = (() => {
        class n {
            ...
            set ngValue(e) {
                this._select != null && (this._value = e, this._setElementValue(Re(this.id, e)), this._select.writeValue(this._select.value))
            }
            set value(e) {
                this._select ? (this._value = e, this._setElementValue(Re(this.id, e)), this._select.writeValue(this._select.value)) : this._setElementValue(e)
            }
            _setElementValue(e) {
                this._renderer.setProperty(this._element.nativeElement, "value", e)
            }
    ...
    class n {
        ...
        ngOnChanges(e) {
            if (this.inputName in e) {
                ...
                this._enabled = this.enabled(i), this._validator = this._enabled ? this.createValidator(i) : Y, this._onChange && this._onChange()
            }
        }
        validate(e) {
    ...
    en = (() => {
        class n extends ct {
            ...
            static \u0275dir = l({
                ...
                hostVars: 1,
                hostBindings: function(i, r) {
                    i & 2 && ae("min", r._enabled ? r.min : null)
                },
                inputs: {
                    min: "min"
                },
...
var nn = (() => {
    class n extends ct {
        ...
        static \u0275dir = l({
            ...
            hostVars: 1,
            hostBindings: function(i, r) {
                i & 2 && ae("required", r._enabled ? "" : null)
            },
            inputs: {
                required: "required"
            },
...
var ht = (() => {
    ...
    ge = class extends O {
        ...
        setValue(t, e = {}) {
            et(this, !1, t), t.forEach((i, r) => {
                Qe(this, !1, r), this.at(r).setValue(i, {
                    onlySelf: !0,
                    emitEvent: e.emitEvent
                })
            }), this.updateValueAndValidity(e)
    ...
    class n {
        ...
        group(e, i = null) {
            let r = this._reduceControls(e),
                s = {};
            return Te(i) ? s = i : i !== null && (s.validators = i.validator, s.asyncValidators = i.asyncValidator), new x(r, s)
        }
        record(e, i = null) {
            let r = this._reduceControls(e);
            return new pe(r, i)
        ...
        control(e, i, r) {
            let s = {};
            return this.useNonNullable ? (Te(i) ? s = i : (s.validators = i, s.asyncValidators = r), new N(e, f(d({}, s), {
                nonNullable: !0
            }))) : new N(e, i, r)
        }
        array(e, i, r) {
...
export {
    A as a, Be as b, Ie as c, C as d, bn as e, An as f, x as g, kt as h, N as i, En as j, Tt as k, Fn as l, Bt as m, Lt as n, Wt as o, zt as p, ut as q, wn as r, In as s, en as t, nn as u, rn as v, Sn as w, Nn as x, On as y
};